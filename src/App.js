...
<div style={{flex:1}}><div style={{fontSize:10,color:MUTED,marginBottom:2}}>QTD</div><input type="number" min="1" value={p.quant} onChange={e=>onChange({...p,quant:parseFloat(e.target.value)||1})} onFocus={e=>e.target.select()} style={{width:'100%',border:`1px solid ${BORDER}`,borderRadius:6,padding:'6px 8px',fontSize:13,boxSizing:'border-box'}}/>
<div style={{flex:1}}><div style={{fontSize:10,color:MUTED,marginBottom:2}}>PREÇO</div><input type="number" min="0" step="0.01" value={p.precoVenda} onChange={e=>onChange({...p,precoVenda:parseFloat(e.target.value)||0})} onFocus={e=>e.target.select()} style={{width:'100%',border:`1px solid ${BORDER}`,borderRadius:6,padding:'6px 8px',fontSize:13,boxSizing:'border-box'}}/>
