...
let logoBase64=''
  try{const r=await fetch('/logo_alimentos_4.png');const b=await r.blob();logoBase64=await new Promise((res,rej)=>{const reader=new FileReader();reader.onload=()=>res(reader.result);reader.onerror=rej;reader.readAsDataURL(b)})}catch(e){}
